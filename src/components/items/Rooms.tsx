...
export const Rooms: React.FC = () => {
	...
	const [uniqueRooms, setUniqueRooms] = useState<RoomType[]>([]);
...
const startSnapshotInterval = (): NodeJS.Timeout => {
  ...
  const handleSnapshotUpdate = (
   ...
   const newRooms = snapshot.docs.map((doc:any) => doc.data().room) as RoomType[];
    const updatedUniqueRooms = [...new Set(newRooms)];
    setUniqueRooms(updatedUniqueRooms);
  };
